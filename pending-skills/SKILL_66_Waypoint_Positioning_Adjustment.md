# SKILL: Waypoint Positioning Adjustment for Safety

## Description
Adjust waypoint positions from channel center to safer offset locations when navigating in restricted visibility to avoid collisions and maintain safe track.

## Prerequisites
- Waypoint safety (SKILL_59)
- Radar overlay usage (SKILL_64)

## Learning Objectives
- Identify when channel-center waypoints are unsafe
- Reposition waypoints to one side of channel
- Use depth contours as navigation guides in fog
- Set appropriate arrival alarms for offset waypoints
